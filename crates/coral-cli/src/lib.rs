...
use coral_api::v1::{
    ClearSearchDataRequest, CreateWorkspaceRequest, DeleteWorkspaceRequest,
    DrainSearchQueueRequest, ExecuteSqlRequest, ListWorkspacesRequest, RebuildSearchIndexRequest,
    SearchClearTarget, SearchDataScope, SearchIndexProvider, SearchProvider, SearchRequest,
    Workspace, search_clear_target, search_maintenance_result,
};
#[cfg(feature = "embedded-ui")]
