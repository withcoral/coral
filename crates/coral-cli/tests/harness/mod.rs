...
use coral_api::v1::{
    ...
    RebuildSearchIndexRequest, RebuildSearchIndexResponse, RemoveWorkspaceMemberRequest,
    RemoveWorkspaceMemberResponse, SearchCatalogRequest, SearchCatalogResponse, SearchField,
