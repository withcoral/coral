...
impl RequestIdentitySelectionContext {
    ...
    #[must_use]
    /// Returns the canonical source name that owns the surface.
    pub fn source_name(&self) -> &str {
        &self.source_name
    }

    #[must_use]
    /// Returns the DSL v4 surface id whose identity is being selected.
    ...
    #[must_use]
    /// Returns whether a candidate identity satisfies this surface.
    ///
...
/// identity requirements while building a query runtime.
#[async_trait]
