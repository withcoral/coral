...
pub use ir::{
    ...
    GraphUnionBranch, GraphUnionOuterProjection, GraphUnionOuterProjectionItem, GraphUnwind,
    GraphUnwindProjection, KeyPredicate, Literal, NodePattern, NullOrder, OptionalMatchScope,
