...
impl<'a> SqlRenderer<'a> {
    ...
    pub(super) fn render_nested_scoped_exists_pattern_predicate<'b, 'c>(
        &self,
    ...
    pub(super) fn render_scoped_count_existence_predicate<'b>(
        &self,
        pattern: &CountSubqueryPattern,
        predicate: CountExistencePredicate,
    ...
    pub(super) fn render_scoped_scalar_expression<'b>(
        ...
        if let Some(rendered) = self.render_simple_scalar_expression(
            expression,
            ScalarScope::Scoped {
                relationships,
                local_nodes,
    ...
    pub(super) fn render_scoped_binding_presence_ref<'b>(
        &self,
        variable: &str,
        relationships: &[ExistsRelationshipSqlBinding<'a, 'b>],
        local_nodes: &BTreeMap<&'b str, &'a Node>,
    ...
    pub(super) fn exists_relationship_for_variable<'b, 'c>(
