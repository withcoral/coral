...
pub(crate) struct FunctionLookupKey {
...
impl FunctionLookupKey {
    ...
    pub(crate) fn from_parts(schema: String, function: String) -> Self {
...
pub(crate) struct FunctionCall {
    pub(crate) lookup_key: FunctionLookupKey,
...
/// [`FunctionCall::parse`] inspects the relation by reference because
...
pub(crate) fn call_parts(relation: TableFactor) -> (TableFunctionArgs, Option<TableAlias>) {
    let TableFactor::Table {
        ...
        unreachable!("FunctionCall::parse only matches table function calls");
    };
    (args, alias)
}
...
pub(crate) fn reject_unsupported_modifiers(
    ...
    let TableFactor::Table {
        ...
        unreachable!("FunctionCall::parse only matches table relations");
    };
...
pub(crate) fn reject_settings(call: &FunctionCall, args: &TableFunctionArgs) -> Result<()> {
...
pub(crate) fn lower_named_args_to_positional_exprs(
    function: &dyn FunctionSignature,
...
fn non_named_arg_error(function: &dyn FunctionSignature, arg: &FunctionArg) -> DataFusionError {
    match arg {
