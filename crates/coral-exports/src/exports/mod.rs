...
pub use model::{
    ...
    CapabilityExport, EffectProfileSnapshot, ExportKind, ExportRef, FileScanProjection,
    PaginationProfile, ResponseSelection, SOURCE_EXPORTS_GENERATOR_VERSION, SourceExports,
