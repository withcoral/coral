...
fn oauth_refresh_config(
    ...
    let token_url_context = format!("OAuth refresh token URL for {material_label}");
...
mod tests {
    ...
    use super::{
        ...
        oauth_credential_material, oauth_metadata_prefix, parse_device_authorization_response,
