...
pub(super) const DEFAULT_TRACE_FILTER: &str = "coral_app=trace,coral_client=trace,coral_mcp=trace,coral_engine=trace,coral_telemetry.trace_safe=trace,coral_engine::datafusion=off,coral.http.body=off,coral.mcp.body=off";
pub(super) const DEFAULT_LOCAL_TRACE_FILTER: &str = "coral_app=trace,coral_client=trace,coral_mcp=trace,coral_engine=trace,coral_telemetry.trace_safe=trace,coral_engine::datafusion=trace,coral.http.body=trace,coral.mcp.body=trace";
pub(super) const DEFAULT_LOG_FILTER: &str =
    "coral_app=info,coral_engine=info,coral_telemetry.log_only=info";
