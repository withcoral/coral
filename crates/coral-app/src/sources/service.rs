...
use coral_api::v1::{
    ...
    OauthDynamicClientRegistrationAuthMethod, ResolveBundledSourceHostsRequest,
    ResolveBundledSourceHostsResponse, Source, SourceConfigCredentialMethod, SourceCredential,
