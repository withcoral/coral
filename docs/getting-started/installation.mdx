...
- **`coral`** — teaches your agent the discovery-first MCP workflow for answering data questions through Coral, including how to use `list_tables`, `coral.tables`, `coral.columns`, and `coral.inputs`.
