...
<Note>
  Coral publishes Developer ID-signed and notarized macOS ZIPs, Linux tarballs,
  and x86_64 Windows ZIPs. Windows support currently targets native Windows
  10/11 on `x86_64-pc-windows-msvc`; ARM64 Windows is not released.
</Note>
