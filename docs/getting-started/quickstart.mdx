...
Use the [system catalog](/concepts/system-catalog) to see all available tables:
...
- **[Use Coral with an agent](/guides/agent-usage)** — expose Coral to Claude Code, Cursor, or VS Code over MCP so your agent can query sources directly
