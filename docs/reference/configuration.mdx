...
| `episodes` | `false` | Experimental. Exposes the MCP `create_episode` tool and lets agents pass `episode_id` on follow-up Coral tool calls for trajectory-memory attribution. |
