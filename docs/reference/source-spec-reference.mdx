...
In V1, dependent join execution buffers resolver rows and dependent fetch
results before producing joined output. Row, binding, and fanout limits are
engine runtime policy, not manifest metadata.
