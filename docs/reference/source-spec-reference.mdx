...
the credential users should prefer first. When every choice references a secret
input, Coral requires at least one of those secrets before the source can be
