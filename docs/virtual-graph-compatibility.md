...
| `RETURN sum/avg/min/max/stDev/stDevP(property)` | Supported foundation | Numeric aggregate projections over mapped properties; `stDev` lowers to sample standard deviation and `stDevP` lowers to population standard deviation |
