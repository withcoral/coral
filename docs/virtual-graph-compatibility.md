...
| GraphQL object defaults | Rejected | Runtime object variables are supported for filter input objects; object defaults remain rejected until schema-level input coercion is modeled |
