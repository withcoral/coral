...
121 scenarios, which is 7.49% of the full upstream scenario-definition inventory
and 9.35% of the read-candidate inventory.
...
The baseline currently contains 121 representative read-only scenarios:
