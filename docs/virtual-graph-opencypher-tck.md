...
288 scenarios, which is 17.83% of the full upstream scenario-definition inventory
and 22.26% of the read-candidate inventory.
...
The baseline currently contains 288 representative read-only scenarios:
