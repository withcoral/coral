...
100 scenarios, which is 6.19% of the full upstream scenario-definition inventory
and 7.73% of the read-candidate inventory.
...
The baseline currently contains 100 representative read-only scenarios:
