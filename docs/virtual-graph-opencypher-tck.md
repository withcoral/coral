...
467 scenarios, which is 28.92% of the full upstream scenario-definition inventory
and 36.09% of the read-candidate inventory.
...
The baseline currently contains 467 representative read-only scenarios:
