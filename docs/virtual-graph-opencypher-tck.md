...
511 scenarios, which is 31.64% of the full upstream scenario-definition inventory
and 39.49% of the read-candidate inventory.
...
The baseline currently contains 511 representative read-only scenarios:
