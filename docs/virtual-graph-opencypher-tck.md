...
66 scenarios, which is 4.09% of the full upstream scenario-definition inventory
and 5.10% of the read-candidate inventory.
...
The baseline currently contains 66 representative read-only scenarios:
