...
116 scenarios, which is 7.18% of the full upstream scenario-definition inventory
and 8.96% of the read-candidate inventory.
...
The baseline currently contains 116 representative read-only scenarios:
...
- `CountSubquery`: 8 scenarios for `COUNT { ... }` projections, predicates,
