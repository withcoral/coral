...
274 scenarios, which is 16.97% of the full upstream scenario-definition inventory
and 21.17% of the read-candidate inventory.
...
The baseline currently contains 274 representative read-only scenarios:
