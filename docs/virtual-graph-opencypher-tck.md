...
477 scenarios, which is 29.54% of the full upstream scenario-definition inventory
and 36.86% of the read-candidate inventory.
...
The baseline currently contains 477 representative read-only scenarios:
