...
519 scenarios, which is 32.14% of the full upstream scenario-definition inventory
and 40.11% of the read-candidate inventory.
...
The baseline currently contains 519 representative read-only scenarios:
