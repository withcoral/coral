...
86 scenarios, which is 5.33% of the full upstream scenario-definition inventory
and 6.65% of the read-candidate inventory.
...
The baseline currently contains 86 representative read-only scenarios:
