...
88 scenarios, which is 5.45% of the full upstream scenario-definition inventory
and 6.80% of the read-candidate inventory.
...
The baseline currently contains 88 representative read-only scenarios:
