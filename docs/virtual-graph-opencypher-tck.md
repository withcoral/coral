...
456 scenarios, which is 28.24% of the full upstream scenario-definition inventory
and 35.24% of the read-candidate inventory.
...
The baseline currently contains 456 representative read-only scenarios:
