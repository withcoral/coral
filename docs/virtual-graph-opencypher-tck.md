...
537 scenarios, which is 33.25% of the full upstream scenario-definition inventory
and 41.50% of the read-candidate inventory.
...
The baseline currently contains 537 representative read-only scenarios:
