...
113 scenarios, which is 7.00% of the full upstream scenario-definition inventory
and 8.73% of the read-candidate inventory.
...
The baseline currently contains 113 representative read-only scenarios:
...
- `CountSubquery`: 5 scenarios for `COUNT { ... }` projections, predicates,
