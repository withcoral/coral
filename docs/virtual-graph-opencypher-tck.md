...
158 scenarios, which is 9.78% of the full upstream scenario-definition inventory
and 12.22% of the read-candidate inventory.
...
The baseline currently contains 158 representative read-only scenarios:
