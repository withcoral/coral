...
82 scenarios, which is 5.08% of the full upstream scenario-definition inventory
and 6.34% of the read-candidate inventory.
...
The baseline currently contains 82 representative read-only scenarios:
