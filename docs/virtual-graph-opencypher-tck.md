...
147 scenarios, which is 9.10% of the full upstream scenario-definition inventory
and 11.37% of the read-candidate inventory.
...
The baseline currently contains 147 representative read-only scenarios:
