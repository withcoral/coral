...
170 scenarios, which is 10.53% of the full upstream scenario-definition inventory
and 13.15% of the read-candidate inventory.
...
The baseline currently contains 170 representative read-only scenarios:
