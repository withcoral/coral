...
371 scenarios, which is 22.97% of the full upstream scenario-definition inventory
and 28.67% of the read-candidate inventory.
...
The baseline currently contains 371 representative read-only scenarios:
