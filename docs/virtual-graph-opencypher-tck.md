...
85 scenarios, which is 5.26% of the full upstream scenario-definition inventory
and 6.57% of the read-candidate inventory.
...
The baseline currently contains 85 representative read-only scenarios:
