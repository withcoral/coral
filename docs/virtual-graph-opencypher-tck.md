...
129 scenarios, which is 7.99% of the full upstream scenario-definition inventory
and 9.97% of the read-candidate inventory.
...
The baseline currently contains 129 representative read-only scenarios:
