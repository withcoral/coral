...
89 scenarios, which is 5.51% of the full upstream scenario-definition inventory
and 6.88% of the read-candidate inventory.
...
The baseline currently contains 89 representative read-only scenarios:
