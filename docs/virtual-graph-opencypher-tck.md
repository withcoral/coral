...
130 scenarios, which is 8.05% of the full upstream scenario-definition inventory
and 10.05% of the read-candidate inventory.
...
The baseline currently contains 130 representative read-only scenarios:
