...
242 scenarios, which is 14.98% of the full upstream scenario-definition inventory
and 18.70% of the read-candidate inventory.
...
The baseline currently contains 242 representative read-only scenarios:
