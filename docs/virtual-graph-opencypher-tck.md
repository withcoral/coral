...
90 scenarios, which is 5.57% of the full upstream scenario-definition inventory
and 6.96% of the read-candidate inventory.
...
The baseline currently contains 90 representative read-only scenarios:
