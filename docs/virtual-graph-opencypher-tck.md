...
110 scenarios, which is 6.81% of the full upstream scenario-definition inventory
and 8.50% of the read-candidate inventory.
...
The baseline currently contains 110 representative read-only scenarios:
