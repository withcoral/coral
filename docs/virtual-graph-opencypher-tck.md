...
431 scenarios, which is 26.69% of the full upstream scenario-definition inventory
and 33.31% of the read-candidate inventory.
...
The baseline currently contains 431 representative read-only scenarios:
