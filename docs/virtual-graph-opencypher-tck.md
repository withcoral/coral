...
99 scenarios, which is 6.13% of the full upstream scenario-definition inventory
and 7.65% of the read-candidate inventory.
...
The baseline currently contains 99 representative read-only scenarios:
...
- `ListExpressions`: 8 scenarios for static `range(...)`, `split(...)`,
