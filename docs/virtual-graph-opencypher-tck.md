...
59 scenarios, which is 3.65% of the full upstream scenario-definition inventory
and 4.56% of the read-candidate inventory.
...
The baseline currently contains 59 representative read-only scenarios:
