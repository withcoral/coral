...
135 scenarios, which is 8.36% of the full upstream scenario-definition inventory
and 10.43% of the read-candidate inventory.
...
The baseline currently contains 135 representative read-only scenarios:
