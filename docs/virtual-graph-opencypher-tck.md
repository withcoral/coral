...
443 scenarios, which is 27.43% of the full upstream scenario-definition inventory
and 34.23% of the read-candidate inventory.
...
The baseline currently contains 443 representative read-only scenarios:
