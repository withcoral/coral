...
97 scenarios, which is 6.01% of the full upstream scenario-definition inventory
and 7.50% of the read-candidate inventory.
...
The baseline currently contains 97 representative read-only scenarios:
...
- `ListExpressions`: 6 scenarios for static `range(...)`, `split(...)`,
