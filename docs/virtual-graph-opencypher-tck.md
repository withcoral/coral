...
80 scenarios, which is 4.95% of the full upstream scenario-definition inventory
and 6.18% of the read-candidate inventory.
...
The baseline currently contains 80 representative read-only scenarios:
