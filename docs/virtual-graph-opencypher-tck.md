...
109 scenarios, which is 6.75% of the full upstream scenario-definition inventory
and 8.42% of the read-candidate inventory.
...
The baseline currently contains 109 representative read-only scenarios:
