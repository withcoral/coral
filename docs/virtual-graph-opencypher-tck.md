...
83 scenarios, which is 5.14% of the full upstream scenario-definition inventory
and 6.41% of the read-candidate inventory.
...
The baseline currently contains 83 representative read-only scenarios:
