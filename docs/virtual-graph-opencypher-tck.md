...
84 scenarios, which is 5.20% of the full upstream scenario-definition inventory
and 6.49% of the read-candidate inventory.
...
The baseline currently contains 84 representative read-only scenarios:
