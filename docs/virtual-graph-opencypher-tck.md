...
The GraphQL baseline currently contains 41 representative read-only scenarios:
...
- `ErrorHandling`: 6 expected rejections for unknown graph-declared properties,
