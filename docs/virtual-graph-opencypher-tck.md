...
384 scenarios, which is 23.78% of the full upstream scenario-definition inventory
and 29.68% of the read-candidate inventory.
...
The baseline currently contains 384 representative read-only scenarios:
