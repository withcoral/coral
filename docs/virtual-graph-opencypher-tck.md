...
98 scenarios, which is 6.07% of the full upstream scenario-definition inventory
and 7.57% of the read-candidate inventory.
...
The baseline currently contains 98 representative read-only scenarios:
...
- `ListExpressions`: 7 scenarios for static `range(...)`, `split(...)`,
