...
- One capability model across APIs, upstream MCP tools, GraphQL, local files,
  and live systems
- Use Coral from the CLI or through MCP search/describe plus Code Mode
- Data, credentials, and query history stay local
- Active bundled sources only when they are SourceSpec-backed
- Bring your own APIs, upstream MCP servers, GraphQL schemas, and files with SourceSpec interfaces
