...
mod tests {
    ...
    fn report_counts_current_baseline() {
        ...
        assert_eq!(report.scenario_count, 158);
        assert_eq!(report.expected_error_count, 13);
        ...
        assert_eq!(report.feature_counts.get("MathematicalFunctions"), Some(&6));
        ...
        assert_eq!(report.feature_counts.get("ScalarExpressions"), Some(&33));
        assert_eq!(report.feature_counts.get("TypeConversion"), Some(&3));
        assert_eq!(report.feature_counts.get("Union"), Some(&4));
        assert_eq!(report.feature_counts.get("Unwind"), Some(&3));
    ...
    fn upstream_report_classifies_feature_groups() {
        ...
        assert_eq!(report.coral_baseline_scenario_count, 158);
        assert_eq!(
            report
                .category_counts
