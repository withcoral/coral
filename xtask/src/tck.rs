...
mod tests {
    ...
    fn report_counts_current_baseline() {
        ...
        assert_eq!(report.scenario_count, 350);
        assert_eq!(report.expected_error_count, 36);
    ...
    fn report_counts_graphql_baseline() {
        ...
        assert_eq!(report.expected_error_count, 6);
    ...
    fn upstream_report_classifies_feature_groups() {
        ...
        assert_eq!(report.coral_baseline_scenario_count, 350);
        assert_eq!(
            report
                .category_counts
