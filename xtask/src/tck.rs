...
mod tests {
    ...
    fn report_counts_current_baseline() {
        ...
        assert_eq!(report.scenario_count, 537);
        assert_eq!(report.expected_error_count, 60);
        assert_eq!(report.feature_counts.get("Aggregation"), Some(&26));
        ...
        assert_eq!(report.feature_counts.get("With"), Some(&30));
    ...
    fn report_counts_graphql_baseline() {
        ...
        assert_eq!(report.scenario_count, 86);
    ...
    fn upstream_report_classifies_feature_groups() {
        ...
        assert_eq!(report.coral_baseline_scenario_count, 537);
        assert_eq!(
            report
                .category_counts
