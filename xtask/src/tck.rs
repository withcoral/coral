...
mod tests {
    ...
    fn report_counts_current_baseline() {
        ...
        assert_eq!(report.scenario_count, 557);
        ...
        assert_eq!(report.feature_counts.get("Temporal"), Some(&13));
        ...
        assert_eq!(report.feature_counts.get("With"), Some(&31));
    ...
    fn upstream_report_classifies_feature_groups() {
        ...
        assert_eq!(report.coral_baseline_scenario_count, 557);
        assert_eq!(
            report
                .category_counts
