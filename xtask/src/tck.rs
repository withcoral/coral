...
mod tests {
    ...
    fn report_counts_current_baseline() {
        ...
        assert_eq!(report.scenario_count, 263);
        assert_eq!(report.expected_error_count, 21);
        ...
        assert_eq!(report.feature_counts.get("ListExpressions"), Some(&26));
        assert_eq!(report.feature_counts.get("LiteralExpressions"), Some(&2));
        assert_eq!(report.feature_counts.get("MapExpressions"), Some(&5));
        assert_eq!(
        ...
        assert_eq!(report.feature_counts.get("With"), Some(&14));
    ...
    fn report_counts_graphql_baseline() {
        ...
        assert_eq!(report.scenario_count, 20);
        assert_eq!(report.expected_error_count, 2);
    ...
    fn upstream_report_classifies_feature_groups() {
        ...
        assert_eq!(report.coral_baseline_scenario_count, 263);
        assert_eq!(
            report
                .category_counts
