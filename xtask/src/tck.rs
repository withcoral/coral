...
mod tests {
    ...
    fn report_counts_current_baseline() {
        ...
        assert_eq!(report.scenario_count, 554);
        assert_eq!(report.expected_error_count, 61);
        ...
        assert_eq!(report.feature_counts.get("Temporal"), Some(&11));
    ...
    fn upstream_report_classifies_feature_groups() {
        ...
        assert_eq!(report.coral_baseline_scenario_count, 554);
        assert_eq!(
            report
                .category_counts
