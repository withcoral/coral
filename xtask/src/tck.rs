...
mod tests {
    ...
    fn report_counts_current_baseline() {
        ...
        assert_eq!(report.scenario_count, 726);
        assert_eq!(report.expected_error_count, 80);
        ...
        assert_eq!(report.feature_counts.get("PathValues"), Some(&23));
    ...
    fn upstream_report_classifies_feature_groups() {
        ...
        assert_eq!(report.coral_baseline_scenario_count, 726);
        assert_eq!(
            report
                .category_counts
