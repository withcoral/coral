...
const INDEX_INTRO: &str = concat!(
    "Coral supports connecting to some data sources out of the box. Specifically, these are the sources in (sources/core)[https://github.com/withcoral/coral/tree/main/sources/core].<br />\n",
