...
function compareSpanStart(a: TraceSpanView, b: TraceSpanView): number {
...
export function buildTimelineTree(spans: TraceSpanView[], rootSpanId?: string): TimelineNode[] {
...
export function useTimelineTree(spans: TraceSpanView[], rootSpanId?: string, traceId?: string) {
