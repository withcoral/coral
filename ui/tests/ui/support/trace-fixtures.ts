...
function bodySpan(
  ...
  const truncatedAttr = kind === 'request' ? 'coral.http.request.body.truncated' : 'coral.http.response.body.truncated'
  const truncated = kind === 'request' ? fixture.requestBodyTruncated : fixture.responseBodyTruncated
